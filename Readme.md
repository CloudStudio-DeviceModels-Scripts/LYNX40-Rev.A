...
# Configuration Script – LYNX40 - Rev. A

This **Configuration** script is designed for the **LYNX40** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – LYNX40 Rev. A

Este script de **Configuration** está diseñado para el modelo **LYNX40** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
