...
# Parsing + Configuration Script – LYNX40 - Rev. A

This **Parsing + Configuration** script is designed for the **LYNX40** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – LYNX40 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **LYNX40** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
